...
The planned path is shown in figure \todo[inline, author=Michael]{I need picture of it here..}
...
\begin{equation}
  ...
  \end{bmatrix}
\end{equation}
The robots position is estimated from the previous position,
plus the movement in the last time period $\Delta t$.
